...
module('Unit | Model | central worship service', function (hooks) {
  ...
  module('validate', function () {
    ...
    test(`it should return an extra error when creating a new ${CLASSIFICATION.CENTRAL_WORSHIP_SERVICE.label} without membershipsOfOrganizations`, async function (assert) {
    ...
    test(`it should not return an extra error when creating a new ${CLASSIFICATION.CENTRAL_WORSHIP_SERVICE.label} with membershipsOfOrganizations`, async function (assert) {
      const classification = this.store().createRecord(
        'administrative-unit-classification-code',
        CLASSIFICATION.CENTRAL_WORSHIP_SERVICE
      );
    ...
    test(`it should not return an extra error when editing an existing ${CLASSIFICATION.CENTRAL_WORSHIP_SERVICE.label} with membershipsOfOrganizations`, async function (assert) {
      const classification = this.store().createRecord(
        'administrative-unit-classification-code',
        CLASSIFICATION.CENTRAL_WORSHIP_SERVICE
      );
