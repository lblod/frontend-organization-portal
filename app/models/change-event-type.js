...
export const CHANGE_EVENT_TYPE = {
  ...
  LEGAL_FORM_CHANGE: '8a4f3c2d-9e1b-4f5a-b7c3-6d8e9f0a1b2c',
  WERKINGSGEBIED_CHANGE: '09ec81e1-2d5a-49dd-a4bc-7c2594108b60',
  ADDITIONAL_QUALIFICATION_CHANGE: 'bde828e9-09da-4b5d-8d5e-f4915c80d2cf',
};
...
export const CHANGE_EVENTS_OCMW = [
  CHANGE_EVENT_TYPE.NAME_CHANGE,
  CHANGE_EVENT_TYPE.LEGAL_FORM_CHANGE,
  CHANGE_EVENT_TYPE.OPRICHTING,
  CHANGE_EVENT_TYPE.FUSIE,
...
export const CHANGE_EVENTS_AGB_APB = [
  ...
  CHANGE_EVENT_TYPE.ADDITIONAL_QUALIFICATION_CHANGE,
  CHANGE_EVENT_TYPE.FUSIE,
];
...
export const CHANGE_EVENTS_PEVA = [
  CHANGE_EVENT_TYPE.NAME_CHANGE,
  CHANGE_EVENT_TYPE.IN_ONTBINDING,
  CHANGE_EVENT_TYPE.OPRICHTING,
  CHANGE_EVENT_TYPE.IN_VEREFFENING,
...
export const CHANGE_EVENTS_VLAAMSE_GEMEENSCHAPSCOMMISSIE = [
  CHANGE_EVENT_TYPE.NAME_CHANGE,
  CHANGE_EVENT_TYPE.ONTBONDEN_EN_VEREFFEND,
  CHANGE_EVENT_TYPE.OPRICHTING,
  CHANGE_EVENT_TYPE.IN_ONTBINDING,
...
export const WORSHIP_ONLY_CHANGE_EVENT_TYPES = [
  CHANGE_EVENT_TYPE.RECOGNITION_NOT_GRANTED,
  CHANGE_EVENT_TYPE.RECOGNITION_LIFTED,
  CHANGE_EVENT_TYPE.RECOGNITION_REQUESTED,
  CHANGE_EVENT_TYPE.RECOGNITION_GRANTED,
...
export const CHANGE_EVENTS_PROVINCE = [
  CHANGE_EVENT_TYPE.WERKINGSGEBIED_CHANGE,
  CHANGE_EVENT_TYPE.LEGAL_FORM_CHANGE,
  CHANGE_EVENT_TYPE.NAME_CHANGE,
  CHANGE_EVENT_TYPE.OPRICHTING,
...
export const CHANGE_EVENTS_INTERLOKALE_VERENIGING_ANDERE = [
  CHANGE_EVENT_TYPE.WERKINGSGEBIED_CHANGE,
  CHANGE_EVENT_TYPE.ADDITIONAL_QUALIFICATION_CHANGE,
  CHANGE_EVENT_TYPE.LEGAL_FORM_CHANGE,
  CHANGE_EVENT_TYPE.NAME_CHANGE,
...
export const CHANGE_EVENTS_REGIONAL_COOPERATION = [
  // Zorgraad, Vervoerregioraad, Regionaal zorgplatform, Regionaal landschap, Bosgroep, Woonmaatschappij
  CHANGE_EVENT_TYPE.WERKINGSGEBIED_CHANGE,
  CHANGE_EVENT_TYPE.LEGAL_FORM_CHANGE,
  CHANGE_EVENT_TYPE.NAME_CHANGE,
  CHANGE_EVENT_TYPE.ONTBONDEN_EN_VEREFFEND,
