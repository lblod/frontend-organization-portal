...
export const CLASSIFICATION_CODE = {
  ...
  REPRESENTATIVE_BODY: CLASSIFICATION.REPRESENTATIVE_BODY.id, // FIXME: this is not an administrative unit
  ...
  PEVA_MUNICIPALITY: CLASSIFICATION.PEVA_MUNICIPALITY.id,
